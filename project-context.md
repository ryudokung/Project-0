...
- **AI Narrative Timeline (Thread & Beads):** 
    - **The Thread:** The core narrative anchor or mission objective defined by the Director (e.g., "Repairing the Radar"). It provides the context and constraints for the AI.
    - **The Beads:** Procedural sub-events and visual reveals generated by AI. These are "strung" onto the thread based on player stats, choices, and environmental context.
    - **Visual DNA Synthesis:** AI dynamically combines Mech DNA, Weapon DNA, and Node Environment into a unique visual prompt for each "Bead," ensuring every moment is personalized.
    - **Context-Aware Generation:** The AI ensures that all generated beads remain consistent with the current "Thread" (e.g., no space travel events while on a planetary repair mission).
...
- [x] Thread & Beads Database Schema (Stars, Nodes, Sessions)
